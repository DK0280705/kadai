...
\bibitem{monad-wadler}
  P.~Wadler,
  ``Monads for functional programming'',
  in \textit{Advanced Functional Programming},
  Lecture Notes in Computer Science, vol.~925, Springer, pp.~24--52, 1995.
...
\bibitem{er-chen}
  ...
  \textit{ACM Transactions on Database Systems},
  vol.~1, no.~1, pp.~9--36, 1976.
